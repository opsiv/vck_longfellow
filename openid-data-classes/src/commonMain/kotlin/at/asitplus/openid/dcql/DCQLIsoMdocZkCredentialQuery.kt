...
/**
 * DCQL credential query for ISO Mdoc with Longfellow ZK support
...
data class DCQLIsoMdocZkCredentialQuery(
    ...
    companion object {
        fun validate(query: DCQLIsoMdocZkCredentialQuery) = query.run {
            DCQLCredentialQuery.validate(this)
            if (format != CredentialFormatEnum.MSO_MDOC_ZK) {
